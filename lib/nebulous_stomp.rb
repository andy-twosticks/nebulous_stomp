...
#
# 2) Question-Answer: a program that sends a request and then waits for a response; the other end
# of the Request-Response use case. We support optional caching of responses in Redis, to speed
# things up if your program is likely to make the same request repeatedly within a short time.
#
